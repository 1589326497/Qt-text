...
#include "../../../project04/test04/Boss.h"
...
QT_MOC_LITERAL(1, 5, 10), // "DeadSignal"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 4), // "_exp"
QT_MOC_LITERAL(4, 22, 12) // "BossDeadSlot"

    },
    "Boss\0DeadSignal\0\0_exp\0BossDeadSlot"
};
...
void Boss::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->DeadSignal(); break;
        case 1: _t->DeadSignal((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->BossDeadSlot(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Boss::DeadSignal)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Boss::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Boss::DeadSignal)) {
                *result = 1;
                return;
            }
...
// SIGNAL 0
void Boss::DeadSignal()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Boss::DeadSignal(int _t1)
{
